    ...
    <div class="col-lg-5">
        <div class="card">
            ...
            <div class="card-body">
                ...
                ?>
                <form action="<?= base_url() ?>admin/projectsCategoryList" method="post" enctype="multipart/form-data">
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-striped table-hover">
                        ...
                        <tbody>
                            <?php foreach($projectCatList as $key => $category){ ?>
                                <tr>
                                    <td><?= ++$key ?></td>
                                    <td><?= $category['name'] ?></td>
