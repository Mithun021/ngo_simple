    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title m-0">Sports Activities </h4>
            </div>
            <div class="card-body">
                <?php
                ...
                ?>
                <form id="sliderForm"  method="post" action="<?= base_url() ?>admin/sports-activities" enctype="multipart/form-data">
                    
                    <div class="form-group">
                        <span for="">Heading</span>
                        <input type="text" class="form-control form-control-sm" name="heading" value="<?= $arvActivity['sports_activity_heading'] ?>">
                    </div>
                    
                    <div class="form-group">
                        <span for="">Long Description</span>
                        <textarea class="form-control form-control-sm snow-editor2" id="cke-editor" name="culture_activity_desc" style="height: 300px;"><?= $arvActivity['sports_activity_desc'] ?></textarea>
                    </div>
