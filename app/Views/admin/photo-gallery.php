...
<div class="row">
    <div class="col-lg-5">
        <div class="card">
            ...
            <div class="card-body">
                ...
                ?>
                <form id="sliderForm" method="post" action="<?= base_url() ?>admin/photo-gallery" enctype="multipart/form-data">
                    
                    <div class="form-group">
                        <span for="">Upload File(JPG,PNG,JPEG) <span class="error">Size - 500X500</span></span>
                        <input type="file" class="form-control form-control-sm" name="photo_gallery[]" accept=".jpg, .png, .jpeg" multiple required>
                    </div>
    ...
    <div class="col-lg-7">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title m-0">Gallery List</h4>
            </div>
            <div class="card-body">
