...
<body style="background-image: url('<?= base_url() ?>public/admin/assets/images/login-bg.jpg'); background-size: cover;">
                                ...
                                <div class="col-lg-12">
                                    <div class="p-5">
                                        <div class="text-center mb-5">
                                            ...
                                            <img src="<?= base_url() ?>public/admin/assets/images/logo.png" alt="" height="70">
                                            </a>
                                        </div>
